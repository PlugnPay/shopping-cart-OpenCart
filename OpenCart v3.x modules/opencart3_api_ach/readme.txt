...
It's also designed for processing ACH/eCheck payments only.
...
catalog/controller/extension/payment/plugnpay_api_ach.php
catalog/view/theme/default/template/extension/payment/plugnpay_api_ach.twig
catalog/model/extension/payment/plugnpay_api_ach.php
catalog/language/en-gb/extension/payment/plugnpay_api_ach.php
admin/controller/extension/payment/plugnpay_api_ach.php
admin/view/template/extension/payment/plugnpay_api_ach.twig
admin/view/image/payment/plugnpay.png
admin/language/en-gb/extension/payment/plugnpay_api_ach.php

2. Go into your OpenCart admin panel.

3. Proceed to the "Extensions -> Payment" page.

4. Use the [Install] option to install the "PlugnPay (API ACH)" extension to the cart.

5. Use the [Edit] option to edit the "PlugnPay (API ACH)" extension settings.
